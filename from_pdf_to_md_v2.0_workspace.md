...
**Novo requisito:** Criar automaticamente o Workspace de Conversão e organizar todos os artefatos nele.
...
**Novo requisito:** Validar a estrutura do Workspace e garantir que todos os artefatos estejam corretamente organizados.
...
# Revisão 2.0 — Integração Completa do Workspace

## Mudanças arquiteturais

- O Workspace passa a ser o produto final oficial da conversão.
- Todas as referências ao resultado final devem considerar o Workspace como unidade de entrega.
- O arquivo Markdown torna-se um artefato interno do Workspace.
...
## Novo responsável (Agente 5)

Além da geração do Markdown, o Agente 5 deve criar e organizar o Workspace.

## Validação (Agente 7)

Também valida:
- estrutura do Workspace;
- presença dos diretórios obrigatórios;
- consistência entre Markdown, metadata e assets.

## Ciclo de vida

- assets: imagens finais utilizadas pelo Markdown.
- metadata: informações do PDF e da conversão.
- logs: histórico de processamento.
- temp: arquivos temporários removíveis ao término.

## Preparação para Markdown → PDF

O Workspace deverá conter todos os recursos necessários para reconstruir o PDF futuramente sem depender do arquivo original.
